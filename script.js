...
st4.addEventListener("mouseleave", ()=>{
  ...
  st4.innerHTML = '<div class="display-1 py-5"><i class="fa-solid fa-ticket"></i></div><div class="h1">Immigration Assistance </div><p class="mt-auto pt-3"><a href="immigrationassistance.html" style="color: white;">Know More..</a></p>';
})
...
st3.addEventListener("mouseleave", ()=>{
  ...
  st3.innerHTML = '<div class="display-1 py-5"><i class="fa-solid fa-landmark-dome"></i></div><div class="h1">Post Landing </div><p class="mt-auto pt-3"><a href="postlanding.html" style="color: white;">Know More..</a></p>';
})
...
st1.addEventListener("mouseleave", ()=>{
  ...
  st1.innerHTML = '<div class="display-1 py-5"><i class="fa-solid fa-globe"></i></div><div class="h1">Cultural Integration </div><p class="mt-auto pt-3"><a href="culturalintegration.html" style="color: white;">Know More..</a></p>';
})
...
st5.addEventListener("mouseleave", ()=>{
  ...
  st5.innerHTML = '<div class="display-1 py-5"><i class="fa-solid fa-plane-departure"></i></div><div class="h1">Affordable Flight </div><p class="mt-auto pt-3"><a href="affordableflights.html" style="color: white;">Know More..</a></p>';
})
